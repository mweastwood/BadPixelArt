...
class ModelOptionsScreen extends ConsumerStatefulWidget {
  ...
  const ModelOptionsScreen({
    super.key,
    this.currentReleaseStage,
    this.currentPreference,
    this.onChanged,
  });

  @override
  ConsumerState<ModelOptionsScreen> createState() => _ModelOptionsScreenState();
}

class _ModelOptionsScreenState extends ConsumerState<ModelOptionsScreen> {
  ...
  void initState() {
    ...
    _selectedStage =
        widget.currentReleaseStage ?? canvasState.modelReleaseStage;
    _selectedPreference =
        widget.currentPreference ?? canvasState.modelPreference;
  ...
  Future<void> _saveOptions() async {
    ...
    await ref
        ...
        .setModelConfig(_selectedStage, _selectedPreference);

    widget.onChanged?.call(_selectedStage, _selectedPreference);
                ...
                children: [
                  ...
                  Row(
                    children: [
                      _buildOptionCard(
                        ...
                        onTap: () =>
                            setState(() => _selectedEngine = AiEngine.local),
                      ),
                      ...
                      _buildOptionCard(
                        ...
                        onTap: () => setState(
                          () => _selectedEngine = AiEngine.geminiCloud,
                        ),
                      ),
                      const SizedBox(width: 8),
                      _buildOptionCard(
                        ...
                        onTap: () => setState(
                          () => _selectedEngine = AiEngine.zhipuCloud,
                        ),
                      ),
                    ],
                  ),
                    ...
                    Row(
                      children: [
                        _buildOptionCard(
                          ...
                          onTap: () =>
                              setState(() => _selectedStage = 'stable'),
                        ),
                        ...
                        _buildOptionCard(
                          ...
                          onTap: () =>
                              setState(() => _selectedStage = 'preview'),
                        ),
                      ],
                    ),
                    const SizedBox(height: 24),
                    ...
                    Row(
                      children: [
                        _buildOptionCard(
                          ...
                          onTap: () =>
                              setState(() => _selectedPreference = 'full'),
                        ),
                        const SizedBox(width: 12),
                        _buildOptionCard(
                          ...
                          onTap: () =>
                              setState(() => _selectedPreference = 'fast'),
                        ),
                      ],
                    ),
                  ],
                  ...
                  SizedBox(
                    ...
                    child: FilledButton.icon(
                      key: const ValueKey('save_model_options_bottom'),
                      icon: const Icon(Icons.save),
                      label: const Text('Save & Apply Options'),
                      onPressed: _saveOptions,
                    ),
                  ),
                ],
