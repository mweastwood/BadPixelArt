...
''',
  ...
  /// Preset 2: 16x16 Fantasy Sword
  static const swordPreset = SpriteTemplate(
    id: 'sword',
    name: 'Sword',
    description: '16x16 fantasy sword with steel blade and hilt',
    width: 16,
    height: 16,
    defaultPrompt: 'pixel art 16x16 glowing magical fantasy sword weapon',
    symbolMapping: {'#': 1, 'o': 2, 'X': 3, '.': 0},
    rawTemplate: '''
..............1.
.............121
...
''',
  ...
  /// Preset 3: 16x16 Potion Bottle
  static const potionPreset = SpriteTemplate(
    id: 'potion',
    name: 'Potion Bottle',
    description: '16x16 magical potion bottle with liquid contents',
    width: 16,
    height: 16,
    defaultPrompt: 'pixel art 16x16 magic mana health potion flask bottle',
    symbolMapping: {'#': 1, 'o': 2, 'X': 3, '.': 0},
    rawTemplate: '''
......1111......
......1221......
...
''',
  ...
  /// Preset 4: 16x16 Heart Health Icon
  static const heartPreset = SpriteTemplate(
    id: 'heart',
    name: 'Heart / Health',
    description: '16x16 retro RPG health heart icon',
    width: 16,
    height: 16,
    defaultPrompt: 'pixel art 16x16 retro rpg heart health icon',
    symbolMapping: {'#': 1, 'o': 2, 'X': 3, '.': 0},
    rawTemplate: '''
................
...111....111...
...
''',
  ...
  static const List<SpriteTemplate> presets = [
    characterPreset,
    swordPreset,
    potionPreset,
    heartPreset,
