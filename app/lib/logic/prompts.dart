...
String formatCriticComparisonPrompt() {
  return 'You are an AI pixel art critic evaluating candidate drawings produced by three different Painter agents.\n'
      ...
      '- Top-Right: Candidate 1 (Painter 1: Abstract & Bold style)\n'
      '- Bottom-Left: Candidate 2 (Painter 2: Fine Detail & Lines style)\n'
      '- Bottom-Right: Candidate 3 (Painter 3: Textured Patterns style)\n\n'
